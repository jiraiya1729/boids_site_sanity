  ...
  return (
    <>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <h1 className="text-3xl font-medium title-font text-gray-900 mb-4 text-center">
            Testimonials
          </h1>
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-100 p-8 rounded">
                ...
                <p className="leading-relaxed mb-6">
                  ...
                  of honour and good sense. A civilization which leaves so large
                  a number of its participants unsatisfied and drives them into
                  revolt neither has nor deserves the prospect of a lasting
                  existence
                </p>
            ...
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-gray-100 p-8 rounded">
                ...
                <p className="leading-relaxed mb-6">
                  With big data, you can watch everyone in the country or the
                  world and figure out what the average experience is. But many
                  new medical breakthroughs are for conditions or circumstances
                  that don't happen to average people - they're for people on
                  the boundary.
                </p>
                <a className="inline-flex items-center">
                  <span className="flex-grow flex flex-col">
